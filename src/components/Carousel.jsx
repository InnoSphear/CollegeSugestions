...
const Carousel = () => {
  ...
  return (
    <div className="relative bg-gradient-to-b from-white via-gray-50 to-white p-6 space-y-10">
      {/* ✅ Custom Animation */}
      <style>{`
        ...
        <div className="flex scroll-right w-[200%]">
          {[...images, ...images].map((img, index) => (
            <a
              key={index}
              href="/some-page"
              className="flex-shrink-0 w-[20%] sm:w-[15%] md:w-[12.5%] px-2"
            >
              <img
                src={img}
                alt="carousel"
      ...
      {/* ✅ MIDDLE STREAM CARDS */}
      <div className="w-full bg-gradient-to-r from-[#091e44] via-[#0c2a66] to-[#091e44] p-6 rounded-lg shadow-lg">
